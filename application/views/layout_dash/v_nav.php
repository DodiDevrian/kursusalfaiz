    ...
    <div class="row g-0">
      ...
      <div class="col-lg-3 col-md-4 sidebar-layout px-0">
        ...
        <div class="py-3">
          ...
          <a href="<?= base_url('mycourses') ?>" class="sidebar-link <?php echo $this->uri->segment(1) == 'mycourses' ? 'active' : '' ?>"><i class="fa-solid fa-book-open"></i> My Learning</a>
          <a href="<?= base_url('bookmark') ?>" class="sidebar-link <?php echo $this->uri->segment(1) == 'bookmark' ? 'active' : '' ?>"><i class="fa-solid fa-bookmark"></i> Bookmark</a>
