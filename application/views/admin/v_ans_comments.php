      ...
      <div class="col-lg-9 col-md-8 p-4 p-lg-5">
        <div class="mb-4">
            <a href="<?= base_url('admin/comments') ?>" class="btn btn-outline-secondary btn-sm rounded-pill font-heading"><i class="fa-solid fa-arrow-left me-1"></i>Kembali</a>
          <span class="text-gold font-heading fw-semibold small" style="letter-spacing: 1px;">Balasan Komentar</span>
          <h1 class="font-heading h3 text-color mb-0"><?= $comments ?></h1>
        </div>
        <?php
